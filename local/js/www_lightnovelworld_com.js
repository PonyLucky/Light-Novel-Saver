function ln_type_www_lightnovelworld_com() {
	...
	$.ajax({
		...
		success: function(response,status) {
			...
			ln_title = htmlDoc.querySelector("div.titles").getElementsByTagName('a')[0].innerHTML;
			...
			ln_chapter_title = htmlDoc.querySelector("div.titles").getElementsByTagName('H2')[0].innerHTML;

			// Get the content of the chapter
			let tmp = htmlDoc.getElementById('chapter-container').getElementsByTagName('p');
			...
			ln_link_next_chapter = htmlDoc.querySelector("a.chnav.next").getAttribute('href');
			//------------------------------------------------------------------------------
			...
			while (isNextChapter) {
				...
				$.ajax({
					...
					success: function(response) {
						...
						if (htmlDoc.querySelector("a.chnav.next").classList.contains('isDisabled')) isNextChapter = false;
						//------------------------------------------------------------------------------
					},
					error: function () {
